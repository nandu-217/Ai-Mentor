...
## GetCourseById
You can execute the `GetCourseById` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):
...
To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `GetCourseById` Query is of type `GetCourseByIdData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
export default function GetCourseByIdComponent() {
  ...
  const query = useGetCourseById({ courseId: ..., });
...
## EnrollUserInCourse
You can execute the `EnrollUserInCourse` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
...
To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `EnrollUserInCourse` Mutation is of type `EnrollUserInCourseData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, EnrollUserInCourseVariables } from '@dataconnect/generated';
import { useEnrollUserInCourse } from '@dataconnect/generated/react'
...
export default function EnrollUserInCourseComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ courseId: ..., status: ..., });
...
export default function SubmitAssignmentComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ lessonId: ..., codeContent: ..., status: ..., });
